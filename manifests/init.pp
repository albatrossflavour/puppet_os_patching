...
class os_patching (
  ...
  Variant[String['absent'], Integer[0,23]] $patch_cron_hour,
  Variant[String['absent'], Integer[1,12]] $patch_cron_month,
  Variant[String['absent'], Integer[1,31]] $patch_cron_monthday,
  Variant[String['absent'], Integer[0,7]] $patch_cron_weekday,
