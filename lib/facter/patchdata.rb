...
Facter.add(:patchdata, :type => :aggregate) do
  ...
  # prerun_command 
  pkginfofile = "/var/patching-data/cache.rpm-qaf"
  kerneldatafile = "/var/patching-data/cache.kernel"
  yumrepolistfile = "/var/patching-data/cache.yum.repolist"
  yumrepolistcode = "/var/patching-data/cache.yum.repolist.code"
  ...
  yumcvecode = "/var/patching-data/cache.yum.listsec.code"
