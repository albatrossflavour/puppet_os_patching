...
Facter.add(:patchdata, :type => :aggregate) do
  ...
  overridefile = "/opt/patching/override.txt"
  # Cached data to avoid exec within custom facts, generated by the Puppet
  # prerun_command 
  pkginfofile = "/opt/patching/cache/cache.rpm-qaf"
  kerneldatafile = "/opt/patching/cache/cache.kernel"
  yumrepolistfile = "/opt/patching/cache/cache.yum.repolist"
  yumrepolistcode = "/opt/patching/cache/cache.yum.repolist.code"
  yumupdatefile = "/opt/patching/cache/cache.yum.cu"
  yumupdatecode = "/opt/patching/cache/cache.yum.cu.code"
  yumsecupdatefile = "/opt/patching/cache/cache.yum.scu"
  yumsecupdatecode = "/opt/patching/cache/cache.yum.scu.code"
  yumcvefile = "/opt/patching/cache/cache.yum.listsec"
