...
Facter.add(:patchdata, :type => :aggregate) do
  ...
  overridefile = "/var/patching-data/override.txt"
  # Cached data to avoid exec within custom facts, generated by the Puppet
  # prerun_command 
  pkginfofile = "/var/patching-data/cache/cache.rpm-qaf"
  kerneldatafile = "/var/patching-data/cache/cache.kernel"
  yumrepolistfile = "/var/patching-data/cache/cache.yum.repolist"
  yumrepolistcode = "/var/patching-data/cache/cache.yum.repolist.code"
  yumupdatefile = "/var/patching-data/cache/cache.yum.cu"
  yumupdatecode = "/var/patching-data/cache/cache.yum.cu.code"
  yumsecupdatefile = "/var/patching-data/cache/cache.yum.scu"
  yumsecupdatecode = "/var/patching-data/cache/cache.yum.scu.code"
  yumcvefile = "/var/patching-data/cache/cache.yum.listsec"
  yumcvecode = "/var/patching-data/cache/cache.yum.listsec.code"
  compliancefile = "/var/patching-data/compliance.txt"
