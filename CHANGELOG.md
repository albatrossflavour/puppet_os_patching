...
- If the lock file tracks a non-real process clean it up [\#239](https://github.com/albatrossflavour/puppet_os_patching/pull/239) ([jcpunk](https://github.com/jcpunk))
- Prevent cronjob from having output [\#238](https://github.com/albatrossflavour/puppet_os_patching/pull/238) ([jcpunk](https://github.com/jcpunk))
- Fact generation json parse [\#232](https://github.com/albatrossflavour/puppet_os_patching/pull/232) ([FrankVanDamme](https://github.com/FrankVanDamme))

**Fixed bugs:**

- os\_patching\_fact\_generation.sh Script runs in nil:NilClass \(NoMethodError\) [\#226](https://github.com/albatrossflavour/puppet_os_patching/issues/226)

**Merged pull requests:**

- Add comma and equals sign to yum regex [\#233](https://github.com/albatrossflavour/puppet_os_patching/pull/233) ([Vincevrp](https://github.com/Vincevrp))
...
- allow open source puppet to use os\_patching [\#215](https://github.com/albatrossflavour/puppet_os_patching/issues/215)
...
- Syntax error with 0.20.0? [\#229](https://github.com/albatrossflavour/puppet_os_patching/issues/229)
...
- stdlib 9.x.x compat [\#227](https://github.com/albatrossflavour/puppet_os_patching/issues/227)
